...
class HMMTagger:
    ...
    def train_unsupervised(cls, data, interpolate=False):
        ...
        for t in uni_transition_counts:
            i = tag_to_index[t]
            uni_transitions[i] = uni_transition_counts / M
    ...
    def interpolate(cls, i, j, k, L):
        ...
        :return: P'
        """
        # Retrieve tags from indices
        # t = cls._tags[i]
        # u = cls._tags[j]
        # v = cls._tags[k]

        # L = cls._lambdas
        # print(cls._tri_transitions[i][j][k])
        # print(cls._bi_transitions[j][k])
        # print(cls._uni_transitions[k])
...
if __name__ == '__main__':
    ...
    end_train_data = 35000      # set size of unsupervised training data/end pos
